#!/usr/bin/env python3
"""
Run full-year backtests for 2022 and 2023 using the production winning config.
...
expired options from 2022/2023 on the free tier. However, the OHLCV endpoints
...
def main():
    print("=" * 70)
    print("HISTORICAL BACKTEST — 2022 & 2023 FULL YEARS")
    ...
    periods = [
        ("2022 Full Year", datetime(2022, 1, 1), datetime(2022, 12, 31)),
        ("2023 Full Year", datetime(2023, 1, 1), datetime(2023, 12, 31)),
    ]

    # Pre-seed option_contracts for both years in one pass
    combined_start = datetime(2022, 1, 1)
    combined_end = datetime(2023, 12, 31)
    ...
    # ── Combined file ──────────────────────────────────────────────────────────
    combined_path = out_dir / "backtest_results_2022_2023.json"
