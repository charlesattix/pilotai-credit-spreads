#!/usr/bin/env python3
"""Run jitter tests on top 10 configs from the 500-run optimizer."""
...
TOP10_PATH = ROOT / "output" / "top10_configs.json"
OUTPUT_PATH = ROOT / "output" / "jitter_top10_results.json"
...
def main():
    ...
    print(f"\n{'='*72}")
    print(f"  JITTER TEST — Top 10 Configs from 500-run Optimizer")
    ...
    # Final ranking by jitter robustness
    # Score = stability_ratio * 0.5 + (profitable_pct) * 0.3 + (1 - cliffs/N) * 0.2
