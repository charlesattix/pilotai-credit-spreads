#!/usr/bin/env python3
"""
Run YTD backtest for 2026 using the production winning config.
...
Pre-seeding used for cache consistency with 2020-2025 scripts.
"""
...
def main():
    print("=" * 70)
    print("HISTORICAL BACKTEST — 2026 YTD")
    ...
    periods = [
        ("2026 YTD", datetime(2026, 1, 1), datetime(2026, 2, 25)),
        
    ]

    # Pre-seed option_contracts for both years in one pass
    combined_start = datetime(2026, 1, 1)
    combined_end = datetime(2026, 2, 25)
    ...
    for r in all_results:
        year = "2026_ytd"
        out_path = out_dir / "backtest_results_polygon_REAL_2026_ytd.json"
        payload = {
    ...
    # ── Combined file ──────────────────────────────────────────────────────────
    combined_path = out_dir / "backtest_results_2026_ytd.json"
